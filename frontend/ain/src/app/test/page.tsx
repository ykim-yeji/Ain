...
export default function Page() {
  return (
    <div
      className='create-ideal-person-page px-[50px] flex flex-col justify-center items-center w-full h-full'
    ...
    >
      ...
      <div className='flex justify-center items-center mb-7'>
        <motion.img src='./image/chevron_down2.png' className='w-[20%]' variants={variants} animate='animate' />
      </div>
